...
async function main(){
    console.log("Powered By Solana Devs");
    const myKeypair = loadWalletKey("WWGNFUTTavvNTnq6NhbPrruCTQxKEP4HmUbqMbcQSq5.json"); // Your KeyPair
    const mint = new web3.PublicKey("WWG8jzi5T74Am9s2pFTNNduBfk21tuuHMyYPRv3uruM"); // Token Address
    ...
    const ourMetadata = { // TODO change those values!
        name: "We Win Gang", 
        symbol: "WWG",
        uri: "https://raw.githubusercontent.com/kensdv/spl-token_test/main/wwg.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
